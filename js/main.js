...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to Stay Ugly! :)\n This site is under construction and will be avaliable soon...",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "This project will talk about privacy and open source projects.",
        "contact.txt": "hi@stay-ugly.com",
        "github.txt": "github.com/Stay-Ugly",
        "instagram.txt": "instagram.com/stay-ugly",
		"aff_ta_tudo_em_ingles.txt": "Bem-vindo ao Stay Ugly. Esse projeto está em desenvolvimento e estará disponível em breve. \n Esse projeto será focado em segurança da informação, privacidade e open source. \n Se quiser conversar comigo, sinta-se a vontade para enviar um e-mail para hi@stay-ugly.com :)",
		"banana.txt": "Você é curioso, aqui está um presente: http://stay-ugly.com/img/ananab.gif"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
